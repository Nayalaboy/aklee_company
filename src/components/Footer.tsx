        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-6 max-w-xs">
              Empowering businesses and individuals through world-class training, enterprise technology, and innovation across the U.S. and Africa.
            </p>
            {/* Newsletter */}
            <div>
              ...
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3.5 py-2 bg-gray-800/80 border border-gray-700/50 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
                />
                <button
                  type="submit"
