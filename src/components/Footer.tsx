    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Aklee</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Empowering businesses and individuals through training, technology, and innovation across the U.S. and Africa.
            </p>
            {/* Newsletter */}
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button
                type="submit"
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} Aklee Company. All rights reserved.</p>
          <div className="flex gap-4">
            ...
            <a href="#" className="text-gray-500 hover:text-white transition" aria-label="LinkedIn">
